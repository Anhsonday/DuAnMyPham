...
<head>
    ...
    <title>Thêm địa chỉ mới - Beauty Store</title>
                ...
                <div class="col-lg-12">
                    <div class="address-form-container">
                        <div class="form-header">
                            ...
                            <p class="form-subtitle">Nhập thông tin địa chỉ của bạn</p>
                        </div>
                        
                        <form action="${pageContext.request.contextPath}/addresses?action=create" method="post" id="addressForm">
                            <!-- Loại địa chỉ -->
                            <div class="form-group">
                                <label class="form-label">Loại địa chỉ <span class="required">*</span></label>
                                <div class="radio-group">
                                    <div class="radio-item">
                                        <input type="radio" id="shipping" name="addressType" value="shipping" checked>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="recipientName" class="form-control" placeholder="Nhập họ và tên..." required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="addressDetail" class="form-control" placeholder="Nhập địa chỉ chi tiết..." required>
                            </div>
