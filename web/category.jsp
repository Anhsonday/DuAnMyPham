                ...
                <div id="main-content" class="main-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-item recently-products-cat md-margin-bottom-39">
                        <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile"
                            ...
                            <c:if test="${not empty allProductsForCarousel}">
                                <c:forEach var="product" items="${allProductsForCarousel}">
                            ...
                            <div class="flt-item to-left group-on-mobile">
                                ...
                                <div class="wrap-selectors">
                                    <form action="category" name="frm-refine" method="get">
                                        <input type="hidden" name="categoryId" value="${not empty selectedCategory ? selectedCategory.categoryId : ''}" />
                            ...
                            <ul class="panigation-contain">
                                <c:if test="${totalPages > 0}">
                                    ...
                                    <c:if test="${currentPage > 1}">
                                        <li>
                                            <a href="category?categoryId=${not empty selectedCategory ? selectedCategory.categoryId : ''}&page=1
                                                <c:if test="${not empty param.price}">&price=${param.price}</c:if>
                                                <c:if test="${not empty param.brand}">&brand=${param.brand}</c:if>
                                                <c:if test="${not empty param.availability}">&availability=${param.availability}</c:if>
                                                <c:if test="${not empty param.sort}">&sort=${param.sort}</c:if>"
                                                class="link-page first"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a>
                                        </li>
                                        <!-- Previous page -->
                                        <li>
                                            <a href="category?categoryId=${not empty selectedCategory ? selectedCategory.categoryId : ''}&page=${currentPage-1}
                                                <c:if test="${not empty param.price}">&price=${param.price}</c:if>
                                                <c:if test="${not empty param.brand}">&brand=${param.brand}</c:if>
                                                <c:if test="${not empty param.availability}">&availability=${param.availability}</c:if>
                                                <c:if test="${not empty param.sort}">&sort=${param.sort}</c:if>"
                                                class="link-page prev"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                                        </li>
                                    </c:if>
                                    ...
                                    <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li>
                                                    <a href="category?categoryId=${not empty selectedCategory ? selectedCategory.categoryId : ''}&page=${i}
                                                        <c:if test="${not empty param.price}">&price=${param.price}</c:if>
                                                        <c:if test="${not empty param.brand}">&brand=${param.brand}</c:if>
                                                        <c:if test="${not empty param.availability}">&availability=${param.availability}</c:if>
                                                        <c:if test="${not empty param.sort}">&sort=${param.sort}</c:if>"
                                    ...
                                    <c:if test="${currentPage < totalPages}">
                                        <li>
                                            <a href="category?categoryId=${not empty selectedCategory ? selectedCategory.categoryId : ''}&page=${currentPage+1}
                                                ...
                                                <c:if test="${not empty param.availability}">&availability=${param.availability}</c:if>
                                                <c:if test="${not empty param.sort}">&sort=${param.sort}</c:if>"
                                                class="link-page next"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        </li>
                                        <!-- Last page -->
                                        <li>
                                            <a href="category?categoryId=${not empty selectedCategory ? selectedCategory.categoryId : ''}&page=${totalPages}
                                                <c:if test="${not empty param.price}">&price=${param.price}</c:if>
                                                <c:if test="${not empty param.brand}">&brand=${param.brand}</c:if>
                                                <c:if test="${not empty param.availability}">&availability=${param.availability}</c:if>
                                                <c:if test="${not empty param.sort}">&sort=${param.sort}</c:if>"
                                                class="link-page last"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                        </li>
                                    </c:if>
                                </c:if>
                            </ul>
