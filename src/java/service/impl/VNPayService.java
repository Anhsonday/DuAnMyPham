...
public class VNPayService {
    ...
    public String createPaymentUrl(HttpServletRequest request, int orderId, String total) throws UnsupportedEncodingException {
        LOGGER.info("Creating VNPay payment URL for order: " + orderId + ", amount: " + total);
        ...
        LOGGER.info("VNPay parameters - Version: " + vnp_Version + ", Command: " + vnp_Command + ", Amount: " + vnp_Amount + ", TxnRef: " + vnp_TxnRef);
