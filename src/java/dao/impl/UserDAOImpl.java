...
public class UserDAOImpl extends GenericDAO<User, Integer> implements UserDAO {
    ...
    public User findByGoogleId(String googleId) {
        String jpql = "SELECT u FROM User u WHERE u.googleId = :googleId AND u.isDeleted = false";
        try {
            return em.createQuery(jpql, User.class)
    ...
    public User findByResetToken(String resetToken) {
        String jpql = "SELECT u FROM User u WHERE u.resetToken = :resetToken AND u.resetTokenExpiry > :now AND u.isDeleted = false";
        try {
            return em.createQuery(jpql, User.class)
